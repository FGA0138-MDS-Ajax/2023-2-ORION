        ...
        <div className="bg-[offwhite] flex flex-col justify-center items-center h-screen">
            ...
            <div className="bg-white w-5/6 h-[80%] mx-auto rounded-b-xl grid justify-center text-center flex-row grid-cols-2">
                <div className='flex justify-center items-center'>
                    <div>
                        <h1 className="font-normal text-black  tex text-[3rem]">Dados de Usuário</h1>
                        <hr className="text-black w-1/2 flex justify-center items-center m-auto opacity-10" />
                        <div className={`m-auto mt-3 mb-6 ${input}`}>%nome%</div>
                        <div className={`m-auto mt-6 mb-6 ${input}`}>%nome social%</div>
                        <div className={`m-auto mt-6 mb-6 ${input}`}>%pronômes%</div>
                        <div className={`m-auto mt-6 mb-3 ${input}`}>%senha%</div>
                        {/* <span>
                                    <Link
