...
export default function login() {
    return (
        ...
        <div className="bg-[white] h-screen w-screen text-center relative overflow-hidden">
            ...
            <div xmlns="http://www.w3.org/1999/xhtml" data-src="https://42f2671d685f51e10fc6-b9fcecea3e50b3b59bdc28dead054ebc.ssl.cf5.rackcdn.com/illustrations/Login_re_4vu2.svg" src="">
